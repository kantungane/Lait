...
<div style=" background-image:radial-gradient(pink 10%,steelblue);margin-top: -20px;height: 40px; ">               
	<h3 style="margin-left: 600px;">Formulaire d'ajout d'une categorie du Travailleur</h3>
</div>
<?php
...
if (isset($_POST['submit'])){
  ...
  $inser=$pdo->prepare("INSERT INTO Categorie_Travailleurs(Designation)VALUES(?)");
